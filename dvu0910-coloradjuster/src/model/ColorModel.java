...
public class ColorModel implements PropertyChangeEnabledMutableColor {
    ...
    private void fireColorChange(final Color theOld) {
        final Color newColor = new Color(myRed, myGreen, myBlue);
        myPcs.firePropertyChange(PROPERTY_COLOR, theOld, newColor);
    }
